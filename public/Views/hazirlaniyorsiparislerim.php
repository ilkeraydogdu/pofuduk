                ...
                <div class="col-12 mb-3">
                    <div class="e-panel card">
                        <div class="card-header">
                            <h3 class="card-title">Hazırlanıyor Siparişler</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="table-responsive mt-4">
                                                        ...
                                                        <?php foreach ($siparisler as $siparis) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <button class="btn btn-sm btn-warning" type="button">Hazırlanıyor</button>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                            ...
                                            <?php } else {
                                                echo '<tr><td colspan="4"><div class="alert alert-info" role="alert">Hazırlanan Siparişler</div></td></tr>';
                                            } ?>
                                        </div>
                                    </div>
                                </div>

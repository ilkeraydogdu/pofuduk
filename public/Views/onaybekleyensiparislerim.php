                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="table-responsive mt-4">
                                                        ...
                                                        <?php foreach ($siparisler as $siparis) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <button class="btn btn-sm btn-info" type="button">Onay Bekliyor</button>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                            ...
                                            <?php } else {
                                                echo '<tr><td colspan="4"><div class="alert alert-info" role="alert">Onay Bekleyen Sipariş bulunamadı!</div></td></tr>';
                                            } ?>
                                        </div>
                                    </div>
                                </div>

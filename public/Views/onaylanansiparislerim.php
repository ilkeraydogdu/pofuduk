                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="table-responsive mt-4">
                                                        ...
                                                        <?php foreach ($siparisler as $siparis) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <button class="btn btn-sm btn-success" type="button">Onaylandı</button>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                            ...
                                            <?php } else {
                                                echo '<tr><td colspan="4"><div class="alert alert-info" role="alert">Onaylanan Sipariş bulunamadı!</div></td></tr>';
                                            } ?>
                                        </div>
                                    </div>
                                </div>

 ...
 <div class="page-header">
 	<div class="page-leftheader">
 		<ol class="breadcrumb">
 			...
 			<li class="breadcrumb-item active" aria-current="page"><a href="#">Kullanıcılar</a></li>
 		</ol>
 	</div>
 </div>
 					...
 					<div class="card-body">
 						<div class="row">
 							<div class="col-6 mb-4">
 								<a href="kullaniciEkle.php" class="btn btn-primary"><i class="fe fe-plus"></i>Yeni Kullanıcı Ekle</a>
 							</div>
 							<div class="col-6 col-auto">
 								<form method="POST">
 									<div class="input-group mb-2">
 										<input type="text" class="form-control" name="arananKelime" placeholder="Kullanıcı Ara" value="<?php echo isset($arananKelime) ? $arananKelime : ''; ?>">
 						...
 						<div class="row">
 							<?php foreach ($kullanicilar as $kullanici) : ?>
 								<?php if ($kullanici['rol'] == "musteri" && $kullanici['durum'] == "aktif") : ?>
 									<div class="col-lg-6">
